<template>
    <section>
        <div :class="style.label">SocialTime</div>
        <div :class="style.hourhand"></div>
        <div :class="style.secondhand"></div>
        <div :class="style.minutehand"></div>
        <div :class="style.hour12"></div>
        <div :class="style.hour1"></div>
        <div :class="style.hour2"></div>
        <div :class="style.hour3"></div>
        <div :class="style.hour4"></div>
        <div :class="style.hour5"></div>
    </section>
</template>
